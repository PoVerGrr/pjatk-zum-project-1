...
class Game:
    def __init__(self, initial_state="         "):
        ...
        self.x_nb = self.state.count(PLAYER_X)
        self.o_nb = self.state.count(PLAYER_O)
    ...
    def check_game_state(self):
        x_in_row = self.is_identical_in_row(PLAYER_X)
        o_in_row = self.is_identical_in_row(PLAYER_O)
        game_state = True
